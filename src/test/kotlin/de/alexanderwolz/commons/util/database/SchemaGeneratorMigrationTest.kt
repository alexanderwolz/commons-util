...
class SchemaGeneratorMigrationTest {
    ...
    fun testFirstWriteCreatesMigrationFile() {
        ...
        gen.testWriteFileForTest(dir, "1000", baseName, body)
        ...
        val pattern = Regex("""V\d{8}_\d{6}__\d{4}_${baseName}\.sql""")
    ...
    fun testUnchangedContentDoesNotRewrite() {
        ...
        gen.testWriteFileForTest(dir, baseName, "1000", body)
    ...
    fun testChangedContentCreatesNewMigrationFile() {
        ...
        gen.testWriteFileForTest(dir, baseName, "1000", v1)
        ...
        gen.testWriteFileForTest(dir, baseName, "1000", v2)
